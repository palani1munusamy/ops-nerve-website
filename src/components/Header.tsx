    ...
    <header className="bg-gradient-to-b from-[#0d0f15]/95 via-[#12141c]/95 to-transparent text-white py-5 px-4 sticky top-0 z-50 border-b border-indigo-500/10 backdrop-blur-md">
      <div className="max-w-6xl mx-auto flex justify-between items-center">
        ...
        <nav className="hidden md:flex space-x-8">
          <a href="#features" className="text-slate-300 hover:text-indigo-300 transition-colors font-medium">Features</a>
          <a href="#how-it-works" className="text-slate-300 hover:text-indigo-300 transition-colors font-medium">How It Works</a>
          <a href="#demo" className="text-slate-300 hover:text-indigo-300 transition-colors font-medium">Demo</a>
          <a href="#contact" className="text-slate-300 hover:text-indigo-300 transition-colors font-medium">Contact</a>
        </nav>
        <button className="relative px-6 py-2 rounded-lg font-semibold overflow-hidden group">
