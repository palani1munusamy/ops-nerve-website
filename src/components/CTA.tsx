  ...
  return (
    <section id="contact" className="relative bg-gradient-to-r from-indigo-900/40 via-purple-900/40 to-indigo-900/40 text-white py-24 px-4 border-t border-indigo-500/20 overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto text-center relative z-10">
        <h2 className="text-3xl md:text-5xl font-bold font-poppins mb-8">Ready to run a smarter, faster, AI-powered ops team?</h2>
        <div className="flex flex-col items-center gap-6 justify-center">
          ...
          <a
            ...
            className="flex items-center gap-2 px-4 py-2 rounded-lg border border-slate-600 hover:border-[#0A66C2]/60 hover:bg-[#0A66C2]/10 transition-all text-slate-400 hover:text-white text-sm whitespace-nowrap"
          >
