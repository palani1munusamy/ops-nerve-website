        ...
        <div className="flex flex-col sm:flex-row items-center gap-6 justify-center">
          <form className="flex flex-col sm:flex-row gap-4 max-w-md w-full">
            ...
            >
              ...
              <span className="relative text-white">See It in Action</span>
            </button>
          </form>
          <div className="flex items-center gap-6">
            <span className="text-slate-500 text-sm hidden sm:block">or</span>
            <a
              href="https://www.linkedin.com/in/palani-munusamy/"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 px-6 py-4 rounded-lg border border-[#0A66C2]/50 bg-[#0A66C2]/10 hover:bg-[#0A66C2]/20 hover:border-[#0A66C2] transition-all text-white font-semibold whitespace-nowrap"
            >
